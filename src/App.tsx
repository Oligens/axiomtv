    ...
    <div className="relative min-h-screen">
      ...
      <div className="pointer-events-none fixed inset-0 z-0">
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 90% 55% at 50% -10%, rgba(0,229,255,0.06), transparent 60%), radial-gradient(ellipse 70% 45% at 85% 110%, rgba(157,78,221,0.07), transparent 60%), radial-gradient(ellipse 50% 40% at 8% 90%, rgba(245,197,66,0.035), transparent 60%)",
          }}
        />
      ...
      <main
        className={`relative z-10 px-4 pb-32 pt-[76px] transition-[padding] duration-300 sm:px-6 md:pb-20 ${
          collapsed ? "md:pl-[92px]" : "md:pl-[92px] lg:pl-[264px]"
        }`}
      >
        <Routes>
